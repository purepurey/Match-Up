...
export default function LoginPage() {
  return (
    <main className="relative w-full min-h-screen bg-[#89BFC4] flex flex-col px-6 pb-8 overflow-hidden">
      ...
      {/* Sign In Button */}
      <Link href="/home" className="w-full bg-[#162D3A] text-white py-4 font-semibold text-base mb-6 block text-center">
      Sign in
      </Link>
      ...
      <div className="flex gap-3 mb-6">
        <button className="flex-1 flex items-center justify-center gap-2 bg-[#F3F2EB] py-3 text-sm font-medium text-[#294957]">
